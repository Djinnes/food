...
(
  "id"                          integer                  GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
  "product__countries_id" integer REFERENCES product__countries (id) ON DELETE CASCADE,
  "product__farms_id"     integer REFERENCES product__farms (id) ON DELETE CASCADE,
