...
(
  "id"         integer                  GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
  "name"       varchar NOT NULL REFERENCES ingredient_variant (id) ON DELETE CASCADE,
  "country_id" integer NOT NULL REFERENCES country (id) ON DELETE CASCADE,
  "created_at" timestamp with time zone DEFAULT current_timestamp,
  "updated_at" timestamp with time zone DEFAULT current_timestamp,
...
(
  "id"                          integer                  GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
  "product_source_countries_id" integer REFERENCES product_source_countries (id) ON DELETE CASCADE,
  "product_source_farms_id"     integer REFERENCES product_source_farms (id) ON DELETE CASCADE,
  "store_id"                    integer NOT NULL REFERENCES store (id) ON DELETE CASCADE,
  "created_at"                  timestamp with time zone DEFAULT current_timestamp,
  "updated_at"                  timestamp with time zone DEFAULT current_timestamp,
  UNIQUE (product_source_countries_id, product_source_farms_id, store_id)
);
